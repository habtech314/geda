...
import { Phone, Calendar, Facebook, Twitter, Instagram, Linkedin, Stethoscope, Home, Info, User, MessageSquare } from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/testimonials', label: t('navigation.testimonials') },
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <a
                ...
                className="text-sm hover:text-white/80 transition-colors flex items-center"
              >
              ...
              <a
                ...
                className="hidden md:inline text-sm hover:text-white/80 transition-colors"
              >
                {t('common.email')}
              </a>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-primary-500 text-2xl font-bold">GEDA</span>
            </Link>
            ...
            <nav className="flex items-center space-x-4 overflow-x-auto">
              ...
              <Link
                to="/appointment"
                className="bg-primary-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-600 transition-colors duration-300 flex items-center whitespace-nowrap hidden sm:flex"
              >
